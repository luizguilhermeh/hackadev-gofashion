...
function Formulario({btnText}){
  return(
    <form className={styles.form}>
        ...
        <Input type="text" text="Data de Nascimento" name="birth" placeholder="___ / ___ / ___" />
        <Input type="text" text="Telefone" name="phone" placeholder="(___) _______-______" />
        <Input type="text" text="Celular" name="cellphone" placeholder="(___) _______-______" />
